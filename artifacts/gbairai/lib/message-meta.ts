...
export function getMessageDisplayContent(content: string) {
  if (isDeletedMessageContent(content)) {
    return {
      displayContent: DELETED_MESSAGE_LABEL,
      isDeleted: true,
